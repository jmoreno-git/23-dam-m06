...
public class TeamDao extends DbDao<Team> {
    ...
    /**
     * the path to the properties file with queries
     */
     ...
     * @throws IOException only when queries are loaded from file and operation fails
     */
    public TeamDao(DbConnector dbConnector) 
            //throws IOException //only when queries are loaded from file
    {
        super(dbConnector);
//        QUERIESFILE = "files/dbteamqueries.properties";
//        super.setQueriesFile(QUERIESFILE);
    }
